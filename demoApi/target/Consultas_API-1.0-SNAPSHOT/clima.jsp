...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Api para el clima</a>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="trm.jsp">Consultar la TRM</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="clima.jsp">Consultar el Clima</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container">
    <h1 class="text-center mb-4">Consultar Clima</h1>
