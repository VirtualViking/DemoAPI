<%@ page import="com.example.demoapi.ApiService" %>
...
<html>
<head>
    <title>Informacion de la TRM</title>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Api para la trm</a>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="trm.jsp">Consultar la TRM</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="clima.jsp">Consultar el Clima</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container">
    <h1 class="text-center mb-4">Consultar TRM</h1>
    ...
    <div class="card p-4 mb-4 card-custom fade-in">
        <form onsubmit="return validateForm()" method="get" class="mb-3">
            <div class="mb-3">
                <label for="date" class="form-label">Ingresa una fecha (YYYY-MM-DD):</label>
